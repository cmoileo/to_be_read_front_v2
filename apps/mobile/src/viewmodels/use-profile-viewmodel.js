...
import { queryKeys, getConnectedUser, setConnectedUser, updateReviewsCount, } from "@repo/stores";
export const useProfileViewModel = () => {
    ...
    const updateMutation = useMutation({
        mutationFn: (data) => MobileProfileService.updateProfile(data),
    ...
    const deleteMutation = useMutation({
        mutationFn: (reviewId) => MobileProfileService.deleteReview(reviewId),
        onMutate: async (reviewId) => {
            ...
            queryClient.setQueryData(queryKeys.myReviews(user?.id), (oldData) => {
                if (!oldData)
                    return oldData;
                return {
                    ...oldData,
