...
Le code ne doit pas être commenté
...
Pour chaque feature, il faut d'abbord la développer sur mobile (tauri), et une fois que c'est validé il faut redévelopper exactement la même feature sur la version web (nextjs)
